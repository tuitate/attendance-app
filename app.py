...
def show_work_status_page():
    ...
    with tab7:
        ...
        # Y軸の最大値を10の倍数に調整
        max_hour_week = df_week['実働時間'].max()
        y_max_week = (int(max_hour_week / 10) + 1) * 10 if max_hour_week > 0 else 10
    ...
    with tab30:
        ...
        max_hour_month = df_month['実働時間'].max()
        y_max_month = (int(max_hour_month / 10) + 1) * 10 if max_hour_month > 0 else 10
    ...
    with tab_year:
        ...
        max_hour_year = all_months['実働時間'].max()
        y_max_year = (int(max_hour_year / 10) + 1) * 10 if max_hour_year > 0 else 10
